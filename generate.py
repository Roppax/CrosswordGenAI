...
class CrosswordCreator () :
    ...
    def enforce_node_consistency(self) :
        ...
        for var in self.crossword.variables :
            # iterate through values in variable
            for val in self.crossword.words :
                # if lengths don't match, remove value from domain
    ...
    def revise(self, x, y) :
        ...
        # loop through all the values in the x domain
        for word1 in self.domains[x] :
            consistent = False
            # loop through all the values in the y domain
            for word2 in self.domains[y] :
                # if no y in y domain and satisfies constraint for x, y
    ...
    def ac3(self, arcs=None) :
        ...
        if not arcs :
            # make new arc
            arcs = []
            # loop through both x and y values in the domains
        ...
        while arcs :
            # revise and update arcs if revised
            a, b = arcs.pop ()
            if self.revise ( a, b ) :
                if len ( self.domains[a] ) == 0 :
                    return False
                for z in self.crossword.neighbors ( a ) - {b} :
                    arcs.append ( (z, a) )
        return True
